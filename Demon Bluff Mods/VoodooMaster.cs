...
namespace Demon_Bluff_Mods
{
    ...
    public class VoodooMaster : CovenFollower
    {
        ...
        public VoodooMaster() : base(ClassInjector.DerivedConstructorPointer<VoodooMaster>())
        {
            ClassInjector.DerivedConstructorBody((Il2CppObjectBase)this);
        }
        public VoodooMaster(System.IntPtr ptr) : base(ptr)
        {
        ...
        public override void Act(ETriggerPhase trigger, Character charRef)
        {
            if (trigger == ETriggerPhase.Start)
            {
                ...
                MelonLogger.Msg($"VM Triggered on #{targetChar.id}");
            } 
