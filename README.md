...
go to your files, and enter the directory where your mod file is located. There should be a file titled "UserData". Open it, click on "PowerplayConfig.cfg" and follow the instructions in the config file.
